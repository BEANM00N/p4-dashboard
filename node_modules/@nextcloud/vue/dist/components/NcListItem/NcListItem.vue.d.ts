declare const _default: import('vue').DefineComponent<import('vue').ExtractPropTypes<{
     ...
     */
    onClick(event: MouseEvent | KeyboardEvent, navigate?: (event: Event) => void, routerLinkHref?: string): void;
    showActions(): void;
    hideActions(): void;
    /**
    ...
    checkSlots(): void;
}, import('vue').ComponentOptionsMixin, import('vue').ComponentOptionsMixin, ("click" | "dragstart" | "update:menuOpen")[], "click" | "dragstart" | "update:menuOpen", import('vue').PublicProps, Readonly<import('vue').ExtractPropTypes<{
    /**
     * The details text displayed in the upper right part of the component
     */
    details: {
