declare const _default: import('vue').DefineComponent<import('vue').ExtractPropTypes<{
...
}, import('vue').ComponentOptionsMixin, import('vue').ComponentOptionsMixin, ("hasError" | "hasResources")[], "hasError" | "hasResources", import('vue').PublicProps, Readonly<import('vue').ExtractPropTypes<{
    /**
     * The provider id implemented with `\OCA\RelatedResources\IRelatedResourceProvider::getProviderId()`
     */
    providerId: {
    ...
    onHasError?: ((...args: any[]) => any) | undefined;
    onHasResources?: ((...args: any[]) => any) | undefined;
}>, {
    providerId: string;
    description: string;
    header: string;
    ...
    NcResource: import('vue').DefineComponent<import('vue').ExtractPropTypes<{
        icon: {
            type: StringConstructor;
            required: true;
        };
    ...
    NcTeamResources: import('vue').DefineComponent<import('vue').ExtractPropTypes<{
        providerId: {
            type: StringConstructor;
            default: null;
        };
        ...
        isVisible(): boolean;
        teamProviders(): (teamId: any) => any;
        open(): (teamId: any) => boolean;
    }, {
        t: (original: string, placeholders?: Record<string, string | number>) => string;
        fetchTeamResources(): Promise<void>;
        toggleOpen(teamId: any, open: any): void;
    }, import('vue').ComponentOptionsMixin, import('vue').ComponentOptionsMixin, {}, string, import('vue').PublicProps, Readonly<import('vue').ExtractPropTypes<{
        providerId: {
            type: StringConstructor;
            default: null;
