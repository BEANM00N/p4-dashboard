 ...
 */
export function REUSELicensesPlugin(options = {}) {
    options = {
        overwriteLicenses: {},
        ...options,
    };
     ...
     */
    function verifyLicenseImpl(license, name, version) {
     ...
     */
    function verifyLicense(license, name, version) {
     ...
     */
    function neededFields(data) {
        // Handle legacy packages
        let license = data.license ?? (Array.isArray(data.licenses)
     ...
     */
    function tryResolve(name, alternative) {
        if (isAbsolute(name)) {
            return name;
        }
        try {
