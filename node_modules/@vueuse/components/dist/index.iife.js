(function(exports, _vueuse_core, vue, _vueuse_shared) {
	...
	const OnClickOutside = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots, emit }) => {
		...
		(0, _vueuse_core.onClickOutside)(target, (e) => {
			emit("trigger", e);
		}, props.options);
		return () => {
	...
	const vOnClickOutside = {
		mounted(el, binding) {
			...
			let stop;
			if (typeof binding.value === "function") stop = (0, _vueuse_core.onClickOutside)(el, binding.value, { capture });
			else {
				const [handler, options] = binding.value;
				stop = (0, _vueuse_core.onClickOutside)(el, handler, Object.assign({ capture }, options));
			}
	...
	const vOnKeyStroke = (0, _vueuse_shared.createDisposableDirective)({ mounted(el, binding) {
		...
		if (typeof binding.value === "function") (0, _vueuse_core.onKeyStroke)(keys, binding.value, { target: el });
		else {
			const [handler, options] = binding.value;
			(0, _vueuse_core.onKeyStroke)(keys, handler, {
				target: el,
				...options
			});
		}
	...
	const OnLongPress = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots, emit }) => {
		const target = (0, vue.shallowRef)();
		const data = (0, _vueuse_core.onLongPress)(target, (e) => {
			emit("trigger", e);
		}, props.options);
		return () => {
	...
	const vOnLongPress = (0, _vueuse_shared.createDisposableDirective)({ mounted(el, binding) {
		if (typeof binding.value === "function") (0, _vueuse_core.onLongPress)(el, binding.value, { modifiers: binding.modifiers });
		else (0, _vueuse_core.onLongPress)(el, ...binding.value);
	} });
	...
	const UseActiveElement = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)({ element: (0, _vueuse_core.useActiveElement)(props) });
		return () => {
	...
	const UseBattery = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)((0, _vueuse_core.useBattery)(props));
		return () => {
			if (slots.default) return slots.default(data);
		};
	}, {
	...
	const UseBrowserLocation = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)((0, _vueuse_core.useBrowserLocation)(props));
		return () => {
			if (slots.default) return slots.default(data);
		};
	}, {
	...
	const UseClipboard = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)((0, _vueuse_core.useClipboard)(props));
		return () => {
			if (slots.default) return slots.default(data);
		};
	}, {
	...
	const UseColorMode = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const mode = (0, _vueuse_core.useColorMode)(props);
	...
	const UseDark = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const isDark = (0, _vueuse_core.useDark)(props);
		const data = (0, vue.reactive)({
			isDark,
			toggleDark: (0, _vueuse_shared.useToggle)(isDark)
		});
		return () => {
			if (slots.default) return slots.default(data);
		};
	...
	const UseDeviceMotion = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, _vueuse_core.useDeviceMotion)(props);
		return () => {
			if (slots.default) return slots.default(data);
		};
	}, {
	...
	const UseDeviceOrientation = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)((0, _vueuse_core.useDeviceOrientation)(props));
		return () => {
			if (slots.default) return slots.default(data);
		};
	}, {
	...
	const UseDevicePixelRatio = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)((0, _vueuse_core.useDevicePixelRatio)(props));
		return () => {
			if (slots.default) return slots.default(data);
		};
	}, {
	...
	const UseDevicesList = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)((0, _vueuse_core.useDevicesList)(props));
		return () => {
			if (slots.default) return slots.default(data);
		};
	}, {
	...
	const UseDocumentVisibility = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)({ visibility: (0, _vueuse_core.useDocumentVisibility)(props) });
		return () => {
			if (slots.default) return slots.default(data);
		};
	}, {
	...
	const UseDraggable = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		...
		const storageValue = props.storageKey && (0, _vueuse_core.useStorage)(props.storageKey, (0, vue.toValue)(props.initialValue) || {
			x: 0,
			y: 0
		}, _vueuse_core.isClient ? props.storageType === "session" ? sessionStorage : localStorage : void 0);
		...
		const data = (0, vue.reactive)((0, _vueuse_core.useDraggable)(target, {
			...props,
			handle,
			initialValue,
			onEnd,
	...
	const UseElementBounding = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const target = (0, vue.shallowRef)();
		const data = (0, vue.reactive)((0, _vueuse_core.useElementBounding)(target, props));
		return () => {
			if (slots.default) return (0, vue.h)(props.as || "div", { ref: target }, slots.default(data));
		};
	}, {
	...
	const vElementBounding = (0, _vueuse_shared.createDisposableDirective)({ mounted(el, binding) {
		const [handler, options] = typeof binding.value === "function" ? [binding.value, {}] : binding.value;
		const { height, bottom, left, right, top, width, x, y } = (0, _vueuse_core.useElementBounding)(el, options);
		(0, vue.watch)([
			height,
			bottom,
			left,
	...
	const vElementHover = (0, _vueuse_shared.createDisposableDirective)({ mounted(el, binding) {
		const value = binding.value;
		if (typeof value === "function") (0, vue.watch)((0, _vueuse_core.useElementHover)(el), (v) => value(v));
		else {
			const [handler, options] = value;
			(0, vue.watch)((0, _vueuse_core.useElementHover)(el, options), (v) => handler(v));
		}
	} });
	//#endregion
	//#region ../core/useElementOverflow/component.ts
	const UseElementOverflow = /* #__PURE__ */ (0, vue.defineComponent)({
		name: "UseElementOverflow",
		props: ["observeMutation", "as"],
		emits: ["update"],
		setup(props, { slots, attrs, emit }) {
			const target = (0, vue.shallowRef)();
			const info = (0, vue.reactive)((0, _vueuse_core.useElementOverflow)(target, {
	...
	//#endregion
	//#region ../core/_configurable.ts
	const defaultWindow$1 = _vueuse_shared.isClient ? window : void 0;
	_vueuse_shared.isClient && window.document;
	_vueuse_shared.isClient && window.navigator;
	_vueuse_shared.isClient && window.location;
	//#endregion
	//#region ../core/unrefElement/index.ts
	/**
	...
	*/
	...
	//#endregion
	//#region ../core/useMounted/index.ts
	/**
	...
	*/
	...
	//#endregion
	//#region ../core/useSupported/index.ts
	/* @__NO_SIDE_EFFECTS__ */
	...
	//#endregion
	//#region ../core/useMutationObserver/index.ts
	/**
	...
	*/
	function useMutationObserver(target, callback, options = {}) {
		...
		const stopWatch = (0, vue.watch)((0, vue.computed)(() => {
			const items = (0, _vueuse_shared.toArray)((0, vue.toValue)(target)).map(unrefElement).filter(_vueuse_shared.notNullish);
		...
		(0, _vueuse_shared.tryOnScopeDispose)(stop);
		return {
			isSupported,
			stop,
			takeRecords
	...
	//#endregion
	//#region ../core/useResizeObserver/index.ts
	/**
	...
	*/
	...
	//#endregion
	//#region ../core/useElementOverflow/index.ts
	/**
	...
	*/
	function useElementOverflow(target, option = {}) {
		const { observeMutation = false, onUpdated, window = defaultWindow$1 } = option;
		const isXOverflowed = (0, vue.shallowRef)(false);
		const isYOverflowed = (0, vue.shallowRef)(false);
		...
		useResizeObserver$1(targets, (entries, observer) => {
			const el = targetEl.value;
			if (el) update(el);
		...
		return {
			isXOverflowed: (0, vue.shallowReadonly)(isXOverflowed),
			isYOverflowed: (0, vue.shallowReadonly)(isYOverflowed),
			stop,
			update: () => {
				const el = targetEl.value;
	...
	//#endregion
	//#region ../core/useElementOverflow/directive.ts
	const vElementOverflow = (0, _vueuse_shared.createDisposableDirective)({ mounted(el, binding) {
		const [handler, options] = typeof binding.value === "function" ? [binding.value] : binding.value;
		const info = useElementOverflow(el, options);
		const { isXOverflowed, isYOverflowed } = info;
		(0, vue.watch)([isXOverflowed, isYOverflowed], () => handler(info), { immediate: true });
	} });
	//#endregion
	...
	const UseElementSize = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		...
		const data = (0, vue.reactive)((0, _vueuse_core.useElementSize)(target, {
	...
	const vElementSize = (0, _vueuse_shared.createDisposableDirective)({ mounted(el, binding) {
		var _binding$value;
		...
		const { width, height } = (0, _vueuse_core.useElementSize)(el, ...typeof binding.value === "function" ? [] : binding.value.slice(1));
		(0, vue.watch)([width, height], ([width, height]) => handler({
			width,
			height
		}), { immediate: true });
	} });
	...
	const UseElementVisibility = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const target = (0, vue.shallowRef)();
		const data = (0, vue.reactive)((0, _vueuse_core.useElementVisibility)(target, {
			...props,
			controls: true
		}));
		return () => {
	...
	const vElementVisibility = (0, _vueuse_shared.createDisposableDirective)({ mounted(el, binding) {
		if (typeof binding.value === "function") {
			const handler = binding.value;
			(0, vue.watch)((0, _vueuse_core.useElementVisibility)(el), (v) => handler(v), { immediate: true });
		} else {
			const [handler, options] = binding.value;
			if (options === null || options === void 0 ? void 0 : options.controls) {
				const state = (0, _vueuse_core.useElementVisibility)(el, options);
				(0, vue.watch)(state.isVisible, () => handler(state), { immediate: true });
			} else (0, vue.watch)((0, _vueuse_core.useElementVisibility)(el, options), (v) => handler(v), { immediate: true });
		}
	} });
	//#endregion
	//#region ../core/useEyeDropper/component.ts
	const UseEyeDropper = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)((0, _vueuse_core.useEyeDropper)(props));
		return () => {
			if (slots.default) return slots.default(data);
		};
	}, {
	...
	const UseFullscreen = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const target = (0, vue.shallowRef)();
		const data = (0, vue.reactive)((0, _vueuse_core.useFullscreen)(target, props));
		return () => {
			if (slots.default) return (0, vue.h)(props.as || "div", { ref: target }, slots.default(data));
		};
	}, {
	...
	const UseGeolocation = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)((0, _vueuse_core.useGeolocation)(props));
		return () => {
			if (slots.default) return slots.default(data);
		};
	}, {
	...
	const UseIdle = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)((0, _vueuse_core.useIdle)(props.timeout, props));
		return () => {
			if (slots.default) return slots.default(data);
		};
	}, {
	...
	const UseImage = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)((0, _vueuse_core.useImage)(props));
		return () => {
	...
	const vInfiniteScroll = (0, _vueuse_shared.createDisposableDirective)({ mounted(el, binding) {
		if (typeof binding.value === "function") (0, _vueuse_core.useInfiniteScroll)(el, binding.value);
		else (0, _vueuse_core.useInfiniteScroll)(el, ...binding.value);
	} });
	//#endregion
	//#region ../core/useIntersectionObserver/directive.ts
	const vIntersectionObserver = (0, _vueuse_shared.createDisposableDirective)({ mounted(el, binding) {
		if (typeof binding.value === "function") (0, _vueuse_core.useIntersectionObserver)(el, binding.value);
		else (0, _vueuse_core.useIntersectionObserver)(el, ...binding.value);
	} });
	//#endregion
	//#region ../core/useMouse/component.ts
	const UseMouse = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)((0, _vueuse_core.useMouse)(props));
		return () => {
			if (slots.default) return slots.default(data);
		};
	}, {
	...
	const UseMouseInElement = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const target = (0, vue.shallowRef)();
		const data = (0, vue.reactive)((0, _vueuse_core.useMouseInElement)(target, props));
		return () => {
			if (slots.default) return (0, vue.h)(props.as || "div", { ref: target }, slots.default(data));
		};
	}, {
	...
	const vMouseInElement = (0, _vueuse_shared.createDisposableDirective)({ mounted(el, binding) {
		const [handler, options] = typeof binding.value === "function" ? [binding.value, {}] : binding.value;
		(0, vue.watch)((0, _vueuse_shared.reactiveOmit)((0, vue.reactive)((0, _vueuse_core.useMouseInElement)(el, options)), "stop"), (val) => handler(val));
	} });
	//#endregion
	//#region ../core/useMousePressed/component.ts
	const UseMousePressed = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const target = (0, vue.shallowRef)();
		const data = (0, vue.reactive)((0, _vueuse_core.useMousePressed)({
			...props,
			target
		}));
		return () => {
	...
	const UseNetwork = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)((0, _vueuse_core.useNetwork)(props));
		return () => {
			if (slots.default) return slots.default(data);
		};
	}, {
	...
	const UseNow = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)((0, _vueuse_core.useNow)({
			...props,
			controls: true
		}));
		return () => {
	...
	const UseObjectUrl = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const { object } = (0, _vueuse_shared.toRefs)(props);
		const url = (0, _vueuse_core.useObjectUrl)(object);
		return () => {
	...
	const UseOffsetPagination = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots, emit }) => {
		const data = (0, vue.reactive)((0, _vueuse_core.useOffsetPagination)({
			...props,
	...
	const UseOnline = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)({ isOnline: (0, _vueuse_core.useOnline)(props) });
		return () => {
			if (slots.default) return slots.default(data);
		};
	}, {
	...
	const UsePageLeave = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)({ isLeft: (0, _vueuse_core.usePageLeave)(props) });
		return () => {
			if (slots.default) return slots.default(data);
		};
	}, {
	...
	const UsePointer = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		...
		const data = (0, vue.reactive)((0, _vueuse_core.usePointer)({
			...props,
			target: props.target === "self" ? el : _vueuse_core.defaultWindow
		}));
		return () => {
			if (slots.default) return slots.default(data);
		};
	...
	const UsePointerLock = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const target = (0, vue.shallowRef)();
		const data = (0, vue.reactive)((0, _vueuse_core.usePointerLock)(target));
		return () => {
			if (slots.default) return (0, vue.h)(props.as || "div", { ref: target }, slots.default(data));
		};
	}, {
	...
	const UsePreferredColorScheme = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)({ colorScheme: (0, _vueuse_core.usePreferredColorScheme)(props) });
		return () => {
			if (slots.default) return slots.default(data);
		};
	}, {
	...
	const UsePreferredContrast = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)({ contrast: (0, _vueuse_core.usePreferredContrast)(props) });
		return () => {
			if (slots.default) return slots.default(data);
		};
	}, {
	...
	const UsePreferredDark = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)({ prefersDark: (0, _vueuse_core.usePreferredDark)(props) });
		return () => {
			if (slots.default) return slots.default(data);
		};
	}, {
	...
	const UsePreferredLanguages = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)({ languages: (0, _vueuse_core.usePreferredLanguages)(props) });
		return () => {
			if (slots.default) return slots.default(data);
		};
	}, {
	...
	const UsePreferredReducedMotion = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)({ motion: (0, _vueuse_core.usePreferredReducedMotion)(props) });
		return () => {
			if (slots.default) return slots.default(data);
		};
	}, {
	...
	const UsePreferredReducedTransparency = /* #__PURE__ */ (0, vue.defineComponent)({
		...
		setup(props, { slots }) {
			const data = (0, vue.reactive)({ transparency: (0, _vueuse_core.usePreferredReducedTransparency)() });
			return () => {
				if (slots.default) return slots.default(data);
			};
		}
	...
	const vResizeObserver = (0, _vueuse_shared.createDisposableDirective)({ mounted(el, binding) {
		if (typeof binding.value === "function") (0, _vueuse_core.useResizeObserver)(el, binding.value);
		else (0, _vueuse_core.useResizeObserver)(el, ...binding.value);
	} });
	//#endregion
	//#region ../core/useScreenSafeArea/component.ts
	const UseScreenSafeArea = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)((0, _vueuse_core.useScreenSafeArea)());
		return () => {
	...
	const vScroll = (0, _vueuse_shared.createDisposableDirective)({ mounted(el, binding) {
		if (typeof binding.value === "function") {
			const handler = binding.value;
			const state = (0, _vueuse_core.useScroll)(el, {
				onScroll() {
					handler(state);
				},
				onStop() {
	...
	function onScrollLock() {
		...
		return (0, _vueuse_shared.createDisposableDirective)((el, binding) => {
			state.value = binding.value;
			if (isMounted) return;
			isMounted = true;
			const isLocked = (0, _vueuse_core.useScrollLock)(el, binding.value);
	...
	const UseTimeAgo = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)((0, _vueuse_core.useTimeAgo)(() => props.time, {
			...props,
			controls: true
		}));
		return () => {
	...
	const UseTimestamp = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)((0, _vueuse_core.useTimestamp)({
			...props,
			controls: true
		}));
		return () => {
	...
	const UseVirtualList = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots, expose }) => {
		...
		const { list, containerProps, wrapperProps, scrollTo } = (0, _vueuse_core.useVirtualList)(listRef, props.options);
		expose({ scrollTo });
	...
	const UseWindowFocus = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)({ focused: (0, _vueuse_core.useWindowFocus)(props) });
		return () => {
			if (slots.default) return slots.default(data);
		};
	}, {
	...
	const UseWindowSize = /* #__PURE__ */ (0, vue.defineComponent)((props, { slots }) => {
		const data = (0, vue.reactive)((0, _vueuse_core.useWindowSize)(props));
		return () => {
			if (slots.default) return slots.default(data);
		};
	}, {
	...
	exports.vElementOverflow = vElementOverflow;
